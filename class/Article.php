...
class Article
{
    ...
    /**
     * @var string la description d�taill�e de l'article
     */
    private $description;

    /**
     * @var int la quantit� d'articles disponible en stock
     */
    private $quantiteStock;

    /**
     * @var bool 1 si le produit est commercialis�, 0 sinon
     */
    private $visible;

    /**
     * @var int l'identifiant de la cat�gorie d'appartenance du produit
     */
    private $categorie;
